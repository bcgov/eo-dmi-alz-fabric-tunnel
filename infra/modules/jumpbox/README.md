...
- **Entra ID SSH Login**: Microsoft Entra ID (AAD) authentication via `AADSSHLoginForLinux` VM extension; developer access uses Entra ID rather than SSH key sign-in
